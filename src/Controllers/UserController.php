	...
	final public  function postValidarDatos(string $endPoint)
	{
		...
		if ($this->method == 'post' & $endPoint == $this->route) {
			...
			if (
				...
				/* El código `new UserModel(->data);` crea una nueva instancia de la clase `UserModel`,	pasando `->data` como parámetro al constructor. Esto permite que el objeto `UserModel`
